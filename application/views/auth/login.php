            ...
            <div class="col-12">
              <div class="row align-items-center">
                <div class="col-lg-6 mb-4">
                  ...
                  <p data-aos="fade-up" data-aos-delay="300"><a href="" class="btn btn-primary py-3 px-5 btn-pill">Read More</a></p>
                </div>

                <!-- form login -->
                <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="500">
                  <form action="<?= site_url('Auth/user_login');?>" method="post" class="form-box">
                    <h3 class="h4 text-black mb-4">Login Mahasiswa</h3>
                    <?= $this->session->flashdata('message'); ?>
                    <div class="form-group">
                      <input type="text" class="form-control" placeholder="Masukan NPM Anda" name="npm" id="npm" value="<?= set_value('npm') ?>">
                    ...
                    <div class="form-group justify-content-center">
                      <button type="submit" class="btn btn-primary btn-pill btn-block">Sign In</button>
                    </div>
                    <div class="text-center">
                        <a class="small" href="<?= base_url('auth/tampil_regist') ?>">Daftar Akun</a>
                    </div>
                     <div class="text-center">
                        <a class="small" href="<?= base_url('Auth/admin') ?>">Login Admin</a>
                    </div>  
                  </form>
                </div>
              </div>
